...
public class ChartFragment extends BaseFragment {
    ...
    private ChartFragment.OnCharSkipListener listener;
...
//        button.setOnClickListener(v ->
        ...
        String[] HORIZONTAL_AXIS = {WrongType.RIGHT_OPTIONS.toString(), WrongType.MISS_OPTIONS.toString(),
...
//        barChart.setDataList(DATA, 5);
    ...
    private void initView() {
        chart = find(R.id.fragment_chart_pie);
