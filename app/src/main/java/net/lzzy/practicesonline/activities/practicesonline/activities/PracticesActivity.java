...
import net.lzzy.practicesonline.activities.practicesonline.fragments.PracticesFragment;
import net.lzzy.practicesonline.activities.practicesonline.models.PracticeFactory;
import net.lzzy.practicesonline.activities.practicesonline.network.DetectWebService;
...
public class PracticesActivity extends BaseActivity implements PracticesFragment.OnPracticesSelectedListener {
    ...
    protected void onResume() {
        super.onResume();
        if (refresh){
            ((PracticesFragment)getFragment()).startRefrom();
        }
    }
