...
import net.lzzy.practicesonline.activities.practicesonline.models.PracticeFactory;
...
import net.lzzy.practicesonline.activities.practicesonline.network.QuestionService;
...
public class PracticesFragment extends BaseFragment {
    ...
    static class QuestionDownLoader extends AsyncTask<Integer, Void, String> {
        ...
        protected String doInBackground(Integer... integers) {
            ...
            try {
                return QuestionService.getQuestionsOfPractoceFromServer(practice.getApiId());
            } catch (IOException e) {
                return e.getMessage();
            }
        }
    ...
    private void downloadQuestion(int apiId) {
        ...
        executor.execute(new Runnable() {
            ...
            public void run() {
                try {
                    String json = QuestionService.getQuestionsOfPractoceFromServer(apiId);
