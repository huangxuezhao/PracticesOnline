...
public class AppUtils extends Application {
    ...
    public static void saveServreSetting(String ip,String port,Context context){
        SharedPreferences spSetting=context.getSharedPreferences(SP_SETTING,MODE_PRIVATE);
        spSetting.edit().putString(URL_IP,ip)
    ...
    public static Pair<String,String>loadServerSetting(Context context){
        ...
        String port=spSetting.getString(URL_IP,"8888");
